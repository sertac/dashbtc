...
/* ── Market data panel ── */
.mkt-grid{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-bottom:6px}
  ...
  <div class="panel" style="grid-row:1/3;overflow-y:auto;max-height:calc(100vh - 50px)">
    ...
    <div id="tech-panel">
      ...
      <div class="dec-row" id="dec-ema">
        ...
        <div class="dec-body">
          <div class="dec-label">EMA 9 / 21</div>
          <div class="dec-val" id="dec-ema-val">—</div>
        </div>
      ...
      <div class="dec-row" id="dec-rsi">
        ...
        <div class="dec-body">
          <div class="dec-label">RSI (14)</div>
          <div class="dec-val" id="dec-rsi-val">—</div>
        </div>
      ...
      <div class="dec-row" id="dec-vol">
        ...
        <div class="dec-body">
          <div class="dec-label">Hacim Spike</div>
          <div class="dec-val" id="dec-vol-val">—</div>
        </div>
      ...
      <div class="dec-row" id="dec-candle">
        ...
        <div class="dec-body">
          <div class="dec-label">Mum Formasyonu</div>
          <div class="dec-val" id="dec-candle-val">—</div>
        </div>
    ...
    <div class="dec-row" id="dec-fr">
      ...
      <div class="dec-body">
        <div class="dec-label">Funding Rate</div>
        <div class="dec-val" id="dec-fr-val">—</div>
      </div>
    ...
    <div class="dec-row" id="dec-oi">
      ...
      <div class="dec-body">
        <div class="dec-label">Open Interest</div>
        <div class="dec-val" id="dec-oi-val">—</div>
      </div>
    ...
    <div class="dec-row" id="dec-ls">
      ...
      <div class="dec-body">
        <div class="dec-label">Long / Short Oranı</div>
        <div class="dec-val" id="dec-ls-val">—</div>
      </div>
    ...
    <div class="dec-row" id="dec-tk">
      ...
      <div class="dec-body">
        <div class="dec-label">Taker Buy / Sell</div>
        <div class="dec-val" id="dec-tk-val">—</div>
      </div>
...
// ── Render: Karar Satırı Yardımcısı ────────────────────────
